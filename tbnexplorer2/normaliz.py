    ...
    def _parse_hilbert_basis(self, output_file: str) -> List[np.ndarray]:
        ...
        with open(output_file, 'r') as f:
            for line in f:
                ...
                if ("lattice points in polytope (Hilbert basis elements of degree 1):" in line or
                    "Hilbert basis elements:" in line):
                    ...
                    continue
                elif in_hilbert_section and any(marker in line for marker in [
                    "extreme rays:", "support hyperplanes:", "equations:",
                ...
                if in_hilbert_section and line and not line.startswith('*'):
                    # Check if line contains only numbers and spaces/minus signs
