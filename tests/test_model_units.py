...
class TestTBNModelUnits(unittest.TestCase):
    ...
    def test_no_concentrations_returns_none(self):
        ...
        monomer_no_conc = Monomer(
            name="A", binding_sites=[BindingSite("a", False)], concentration=None, original_line="A: a"
        )
    ...
    def test_mixed_concentrations_returns_none(self):
        ...
        monomer_with_conc = Monomer(
            name="A", binding_sites=[BindingSite("a", False)], concentration=100.0, original_line="A: a, 100.0"
        )

        monomer_no_conc = Monomer(
            name="B", binding_sites=[BindingSite("b", False)], concentration=None, original_line="B: b"
        )
