...
class TestPolymatWriter:
    ...
    def test_write_with_free_energies(self):
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            columns_line = [line for line in lines if "# Columns:" in line][0]
...
"""
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            assert header['has_free_energies'] == True
            assert header['has_concentrations'] == False
...
"""
    ...
    def test_file_not_found(self):
        ...
        with pytest.raises(FileNotFoundError):
            reader = PolymatReader("/nonexistent/file.tbnpolymat")
...
"""
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            # Test matching hash
            assert check_matrix_hash(file_path, "hash123") == True
            
            # Test non-matching hash
            assert check_matrix_hash(file_path, "wrong_hash") == False
            
            # Test non-existent file
            assert check_matrix_hash("/nonexistent/file.tbnpolymat", "hash123") == False
