...
class TestPolymer:
    ...
    def test_free_energy_dimer(self):
        ...
        monomer1 = Monomer(name="M1", binding_sites=[BindingSite("a", False)], 
                          concentration=100, original_line="M1: a")
        monomer2 = Monomer(name="M2", binding_sites=[BindingSite("a", True)], 
                          concentration=100, original_line="M2: a*")
    ...
    def test_free_energy_complex_polymer(self):
        ...
        # M1: a b
        # M2: a* b*
        monomer1 = Monomer(name="M1", 
                          binding_sites=[BindingSite("a", False), BindingSite("b", False)], 
                          concentration=100, original_line="M1: a b")
        monomer2 = Monomer(name="M2", 
                          binding_sites=[BindingSite("a", True), BindingSite("b", True)], 
                          concentration=100, original_line="M2: a* b*")
    ...
    def test_free_energy_partial_binding(self):
        ...
        monomer2 = Monomer(name="M2", 
                          ...
                          concentration=100, original_line="M2: a* c")
    ...
    def test_free_energy_no_tbn_error(self):
        ...
        monomer = Monomer(name="M1", binding_sites=[BindingSite("a", False)], 
                         concentration=100, original_line="M1: a")
    ...
    def test_free_energy_cached(self):
        ...
        # Compute once
        energy1 = polymer.compute_free_energy()
